...
"""В данном примере мы создаем класс Date с приватными атрибутами _day, _month, _year, которые устанавливаются при создании объекта через конструктор __init__. Мы используем декораторы @classmethod для создания классового метода from_string, который принимает строку в формате dd-mm-yyyy и возвращает объект класса Date, состоящий из соответствующих числовых значений дня, месяца и года."""
class Date:
